...
<div class="w-3/5 mx-auto flex flex-col max-w-md">
    ...
    <!--    테스트 바    -->
    <div role="status" class="max-w-md p-4 space-y-4 border border-gray-200 rounded shadow md:p-6">
        ...
        <div class="flex justify-end">
            <a
                href="#"
                class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-[#f3651f] rounded-lg focus:ring-4 focus:outline-none"
            >
                시승 신청하러 가기
                <svg

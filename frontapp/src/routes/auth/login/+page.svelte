...
<div class="container my-3 mx-auto p-4">
	<div class="container my-3 mx-auto">
		...
		<form class="flex-col text-center" method="post" action="http://localhost:8080/api/v1/member/login" use:enhance>
			<div class="login_box">
				<input
					type="text"
					id="username"
		...
		<div class="flex justify-center mt-2 text-gray-500">
			...
			<a href="/hellocar/login_search" class="px-2 underline hover:text-blue-500">
				<span>ID 찾기</span>
			</a>
			<span class="mx-1">|</span>
			<a href="/hellocar/password_search" class="px-2 underline hover:text-blue-500">
				<span>PW 찾기</span>
			</a>
		</div>
	</div>

...
<!--        <a href="/oauth2/authorization/kakao" class="w-full h-12 mt-6 text-[#6d2720] bg-[#fff30c] hover:bg-[#d4d013]/90 text-sm py-3 flex justify-center">-->
<!--            <svg-->
...
<!--        </a>-->
        <a href={KAKAO_AUTH_URL} class="rounded-lg w-full h-12 mt-6 text-[#6d2720] bg-[#fff30c] hover:bg-[#d4d013]/90 text-sm py-3 flex justify-center">
            <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 48 48"
                    height="24px"

...
<Footer class="p-2 w-full shadow fixed bottom-0 bg-[#f3651f]">
    <FooterLinkGroup ulClass="flex justify-between text-sm font-medium text-white">
        <FooterLink href="/wish-list" class="hover:underline">
            <svg
            ...
            <p class="text-center mt-1">찜 목록</p></FooterLink>
        <FooterLink href="/testdrive-list" class="hover:underline">
            <svg
                    class="w-6 h-6 text-gray-800 text-white mx-auto"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="text-center mt-1">시승내역</p>
        </FooterLink>
        <FooterLink href="/car-home" class="hover:underline">
            <svg
        ...
        <FooterLink href="/my-page" class="hover:underline">
            <svg
                    class="w-6 h-6 text-gray-800 text-white mx-auto"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <p class="text-center mt-1">내 정보</p>
        </FooterLink>
    </FooterLinkGroup>
</Footer>

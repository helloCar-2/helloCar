<script>
    ...
    function testDrive() {
        window.location.href = '/testdrive-list';
    }

    function chatQna() {
        window.location.href = '/chat-qna';
    }
    ...
    <FooterLinkGroup ulClass="flex justify-between text-sm font-medium text-white">
        <FooterLink class="hover:underline">
            <div on:click={select}>
                ...
                <p class="text-center mt-1">찜 목록</p>
            </div>
        </FooterLink>
        <FooterLink class="hover:underline">
            <div on:click={testDrive}>
                <svg
                        class="w-6 h-6 text-gray-800 text-white mx-auto"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <FooterLink href="/car-home" class="hover:underline">
            <div on:click={home}>
                ...
                <p class="text-center mt-1">홈</p>
            </div>
        </FooterLink>
        <FooterLink class="hover:underline">
            <div on:click={chatQna}>
                <svg
                        class="w-6 h-6 text-gray-800 text-white mx-auto"
                        aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg"
